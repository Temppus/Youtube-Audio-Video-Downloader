...
namespace YoutubeExtractor
{
    ...
    public abstract class Downloader
    {
        ...
        {
            Init(video, savePath, bytesToDownload);
        }

        /// <summary>
        /// Added For wrapping purpose. Need to call Init manually.
        /// </summary>
        protected Downloader()
        {
            this.Video = null;
            this.SavePath = null;
            this.BytesToDownload = null;
        }

        public void Init(VideoInfo video, string savePath, int? bytesToDownload = null)
        {
            if (video == null)
